...
@foreach($cursosFiltrados as $curso)
    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 cuadroCurso">
        <div class="col-md-11 col-md-offset-1 cuadro box">
            <div class="btnCurso" style="position: absolute; right:15px; bottom: 15px;"><a href="http://mx.mexicox.gob.mx/courses/{{$curso->course_id}}/about"><img style="width:7%;" class="pull-right" src="{{asset('img/botonIrCurso.png')}}" ></a></div>
