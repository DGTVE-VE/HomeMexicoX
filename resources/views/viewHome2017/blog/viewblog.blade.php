@extends('home2017')
@section('menuMexicoX')
@include('viewHome2017.blog.encabezadoBlog')
@endsection
@section('cuerpoMexicoX')
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous"-->
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:30px"></div>
    ...
    <div class="col-xs-12 col-sm-10 col-md-6 col-lg-6" style="margin-bottom:20px;">
        ...
        <div class="col-md-2"></div>
          <div class="col-md-8"><img src="http://reportes.mexicox.gob.mx/imagenes_entradas/{{$entrada[0]->imagen}}" class="img-responsive center-block"></div>
          <div class="col-md-2"></div>
            <div class="col-md-12"><br><br></div>
